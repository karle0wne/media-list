...
test("RAWG covers are resized while unrelated providers and unknown paths stay untouched", () => {
  ...
  assert.equal(normalizeProviderCoverUrl(rawg), "https://media.rawg.io/media/resize/200/-/games/example.jpg");
